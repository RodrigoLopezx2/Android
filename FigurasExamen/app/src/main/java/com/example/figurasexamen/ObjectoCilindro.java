...
public class ObjectoCilindro {    // Posee los datos del objeto 3D
    float f12d, objSize;
    ...
    ObjectoCilindro() {    // CAMBIAR LAS COORDENADAS X,Y,Z CON 0,1 PARA CONSTRUIR PRISMA, CILINDRO, PIRAMIDE, CONO Y ESFERA.
        ...
        listPoints3D.add(new Point3D(-1, 1, 1));
        listPoints3D.add(new Point3D(-1, -1, 1));
        generarCilindro(listPoints3D, 1,1, 50);
    ...
    public void generarCilindro(List<Point3D> listPoints3D,double altura, double radioBase, int resolucion) {
